                            ...
                            <div className="content-box">
                                <div className="inner">
                                    <div className="view-btn">
                                        <a href="assets/images/project/project-4.jpg" className="lightbox-image" data-fancybox="gallery">
                                        <i className="icon-16"></i>
                                        </a>
                                    </div>
                                    <h3><a href="/portfolio">Business Planning</a></h3>
                    ...
                    <div className="project-block-one">
                        <div className="inner-box">
                            ...
                            <div className="content-box">
                                <div className="inner">
                                    <div className="view-btn">
                                        <a href="assets/images/project/project-5.jpg" className="lightbox-image" data-fancybox="gallery">
                                        <i className="icon-16"></i>
                                        </a>
                                    </div>
                                    <h3><a href="/portfolio">Market Analysis</a></h3>
                    ...
                    <div className="project-block-one">
                        <div className="inner-box">
                            ...
                            <div className="content-box">
                                <div className="inner">
                                    <div className="view-btn">
                                        <a href="assets/images/project/project-6.jpg" className="lightbox-image" data-fancybox="gallery">
                                        <i className="icon-16"></i>
                                        </a>
                                    </div>
                                    <h3><a href="/portfolio">Business Leadership</a></h3>
                ...
                <div className="col-lg-4 col-md-6 col-sm-12 masonry-item all cat-1 cat-3 col-lg-4 col-md-6 col-sm-12">
                    <div className="project-block-one">
                        ...
                        <div className="content-box">
                            <div className="inner">
                                <div className="view-btn">
                                    <a href="assets/images/project/project-7.jpg" className="lightbox-image" data-fancybox="gallery">
                                    <i className="icon-16"></i>
                                    </a>
                                </div>
                                <h3><a href="/portfolio">Strength Solutions</a></h3>
                    ...
                    <div className="project-block-one">
                        <div className="inner-box">
                            ...
                            <div className="content-box">
                                <div className="inner">
                                    <div className="view-btn">
                                        <a href="assets/images/project/project-8.jpg" className="lightbox-image" data-fancybox="gallery">
                                        <i className="icon-16"></i>
                                        </a>
                                    </div>
                                    <h3><a href="/portfolio">Strength Solutions</a></h3>
                    ...
                    <div className="project-block-one">
                        <div className="inner-box">
                            ...
                            <div className="content-box">
                                <div className="inner">
                                    <div className="view-btn">
                                        <a href="assets/images/project/project-9.jpg" className="lightbox-image" data-fancybox="gallery">
                                        <i className="icon-16"></i>
                                        </a>
                                    </div>
                                    <h3><a href="/portfolio">Startup Business</a></h3>
                                    <span className="designation">Marketing</span>
                                </div>
                            </div>
                        </div>
